...
Environment: local Ubuntu-compatible development host in this workspace.
...
ASan tests disable LeakSanitizer in this managed execution environment because LeakSanitizer reports that it cannot operate under ptrace. AddressSanitizer instrumentation remains enabled.
